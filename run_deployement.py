from pipelines.deployement_pipeline import continuous_deployment_pipeline
import click
from pipelines.deployement_pipeline import (
...
#deployement and inference (prediction)
